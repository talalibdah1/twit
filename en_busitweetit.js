...
//var config = require();
var T = new Twit({
  consumer_key:         'LUPct4RuGjfAGU4GC5ARA80lh',
  consumer_secret:      'f1MFMf9j56TAdWhW5pdBRoNy2hNMQr5gLF0B0yBplY9zKxilj9',
  access_token:         '931938108249137154-kKOthyuvcGhkDHQ9GDt0NyBZPamvEMu',
  access_token_secret:  'rEbcwUxaloS9lTKwKFCVNneEtau0mw0kGRjb1wJ8E4BGu'
...
function callTrending (country, category, token) {
  return new Promise((resolve, reject) => {
    ...
    let path = '/api/1.1/topics?limit=10&page=1&response_mode=full&trendingStatus=3&category=Business&language=en';
    let index=2;
  ...
  return new Promise((resolve, reject) => {
          ...
          var req = http.request(options, function (res) {
              ...
              res.on('end', () => { 
                ...
                output2=texto+' '+key1+' '+key2+' '+'. RT & Follow to Get Free Amazon Gift Card'+' '+short+'~'+tweetbody;
